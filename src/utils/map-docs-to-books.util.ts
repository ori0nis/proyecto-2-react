//? Este util mapea un tipo OpenLibraryDoc (la respuesta cruda de búsqueda por título) a BookFromTitleSearch, el tipo que consumen useFetch y los componentes

import type { BookFromTitleSearch, OpenLibraryDoc } from "../models/book";

export const mapDocsToBooks = (doc: OpenLibraryDoc, index: number): BookFromTitleSearch => ({
  book_details: {
    title: doc.title,

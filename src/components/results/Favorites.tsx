      ...
      >
        {favorites.map((favorite) => (
          <div
            ...
            } cursor-pointer border border-[var(--border-gray-byblos)] rounded-lg p-2 hover:scale-105 transition-transform duration-300 ease-in-out`}
          >
            <div
              onClick={() => {
              ...
              className={listView ? "flex flex-row items-center gap-4 flex-1" : "flex flex-col items-center gap-0.5"}
            >
              <img

...
export const RecommendationsButton = ({ toggle }: Props) => {
  return (
    <NavLink
      to="#"
      className="flex flex-col items-center xs:flex-row py-2 px-2.5 cursor-pointer hover:bg-amber-200 hover:rounded-lg"
      onClick={toggle}
    >
      <div className="flex items-center gap-2">
        ...
        <span className="hidden xs:inline xs:text-sm text-center font-semibold">
          Discover new books
        </span>
      </div>
